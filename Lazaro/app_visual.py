...
with st.sidebar:
    ...
    # 1. Buscamos si existe la clave en los secretos de Streamlit Cloud
    if "OPENWEATHER_KEY" in st.secrets:
        default_key = st.secrets["OPENWEATHER_KEY"]
    else:
        # Si estamos en tu laptop y no has configurado secrets.toml, puedes dejarla vacía
        # o ponerla aquí temporalmente solo para pruebas locales.
        default_key = "" 
    
    # 2. Usamos esa variable como valor por defecto
